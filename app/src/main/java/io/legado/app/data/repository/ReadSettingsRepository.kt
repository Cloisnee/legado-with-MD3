...
class ReadSettingsRepository(
    ...
    internal fun Preferences.toReadSettings(): ReadSettings {
        ...
        return ReadSettings(
            ...
            hideStatusBar = compatDsValue(Keys.HideStatusBar, true),
            hideNavigationBar = compatDsValue(Keys.HideNavigationBar, true),
            ...
            textFullJustify = compatDsValue(Keys.TextFullJustify, false),
            textBottomJustify = compatDsValue(Keys.TextBottomJustify, true),
            adaptSpecialStyle = compatDsValue(Keys.AdaptSpecialStyle, false),
            ...
            mouseWheelPage = compatDsValue(Keys.MouseWheelPage, false),
            ...
            readingAnchorEnabled = compatDsValue(Keys.ReadingAnchorEnabled, false),
