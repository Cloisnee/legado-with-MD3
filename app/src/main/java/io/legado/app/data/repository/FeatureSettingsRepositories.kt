...
internal fun Preferences.toBackupSettings(): BackupSettings = BackupSettings(
    ...
    autoCheckNewBackup = compatDsBoolean(PreferKey.autoCheckNewBackup) ?: false,
    onlyLatestBackup = compatDsBoolean(PreferKey.onlyLatestBackup) ?: false,
...
internal fun Preferences.toAppShellSettings(): AppShellSettings = AppShellSettings(
    ...
    showDiscovery = compatDsBoolean(PreferKey.showDiscovery) ?: false,
    ...
    predictiveBackEnabled = compatDsBoolean(PreferKey.isPredictiveBackEnabled) ?: false,
    showBottomView = compatDsBoolean(PreferKey.showBottomView) ?: true,
    useFloatingBottomBar = compatDsBoolean(PreferKey.useFloatingBottomBar) ?: true,
...
internal fun Preferences.toOtherSettings(): OtherSettings {
    ...
    return OtherSettings(
        ...
        autoClearExpired = compatDsBoolean(PreferKey.autoClearExpired) ?: false,
